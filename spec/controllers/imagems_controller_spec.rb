...
RSpec.describe ImagemsController, type: :controller do
  ...
  # ImagemsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the imagems list" do
      imagem = Imagem.create! valid_attributes
      delete :destroy, params: {id: imagem.to_param}, session: valid_session
      expect(response).to redirect_to(imagems_url)
    end
  end
